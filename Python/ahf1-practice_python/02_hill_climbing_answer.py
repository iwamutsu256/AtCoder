...
def solve_hill_climbing(input_data: Input, output_data_greedy: Output) -> Output:
    ...
    while True:
        ...
        i = random.randrange(0, input_data.pickup_count) + input_data.pickup_count + 1
        j = random.randrange(0, input_data.pickup_count) + input_data.pickup_count + 1
